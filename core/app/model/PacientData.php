...
class PacientData
{
    ...
    public function add()
    {
        ...
        $sql .= "value (\"$this->name\",\"$this->trimlastname\",\"$this->gender\",\"$this->day_of_birth\",\"$this->address\",\"$this->phone\",\"$this->email\",\"$this->sick\",\"$this->medicaments\",\"$this->alergy\",\"$this->created_at\",\"$this->second_lastname\",\"$this->curp\",\"$this->state\",\"$this->born_state\",\"$this->nacionality\",\"$this->localidad\",\"$this->municipal\")";
        Executor::doit($sql);
    }
